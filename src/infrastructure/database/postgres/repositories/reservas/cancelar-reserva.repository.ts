...
import { ICancelarReservaRepository } from '../../../../../application/use-cases/reservas/cancelar-reserva/cancelar-reserva.repository.interface';

@Injectable()
export class CancelarReservaRepository implements ICancelarReservaRepository {
    constructor(
