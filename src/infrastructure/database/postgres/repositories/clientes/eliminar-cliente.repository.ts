...
import { IEliminarClienteRepository } from '../../../../../application/use-cases/clientes/eliminar-cliente/eliminar-cliente.repository.interface';

@Injectable()
export class EliminarClienteRepository implements IEliminarClienteRepository {
  constructor(
