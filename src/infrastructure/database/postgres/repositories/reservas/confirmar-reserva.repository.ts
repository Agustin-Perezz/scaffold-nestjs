...
import { IConfirmarReservaRepository } from '../../../../../application/use-cases/reservas/confirmar-reserva/confirmar-reserva.repository.interface';

@Injectable()
export class ConfirmarReservaRepository implements IConfirmarReservaRepository {
    constructor(
